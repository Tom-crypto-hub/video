...
public class QiNiuUtil {
    ...
    public final static Zone zone = Zone.zone0();
     ...
     * @return
     */
    public static boolean upload(Qny qny, String localFilePath, String key, boolean override){
        //构造一个带指定Zone对象的配置类
        ...
        String upToken;
        if(override){
            upToken = auth.uploadToken(qny.getBucket(), key);//覆盖上传凭证
        }else{
            upToken = auth.uploadToken(qny.getBucket());
        }
        try {
     ...
     * @throws IOException
     */
    public static boolean uploadBase64(int l, String file64, String key, boolean override, Qny qny) throws IOException{
     ...
     */
    public static String fileUrl(String fileName, Qny qny) throws UnsupportedEncodingException {
     ...
     * @throws IOException
     */
    public static String uploadMultipartFile(MultipartFile file, String key, boolean override, Qny qny) {
        //构造一个带指定Zone对象的配置类
        Configuration cfg = new Configuration(zone);
        //...其他参数参考类注释
        UploadManager uploadManager = new UploadManager(cfg);
        ...
        try {
            ...
            return qny.getDomain() + putRet.hash;
