...
<!--字体图标-->
<link href="${pageContext.request.contextPath}/static/default/javaex/pc/css/icomoon.css" rel="stylesheet" type="text/css" />
<!--动画-->
<link href="${pageContext.request.contextPath}/static/default/javaex/pc/css/animate.css" rel="stylesheet" type="text/css" />
<!--骨架样式-->
<link href="${pageContext.request.contextPath}/static/default/javaex/pc/css/common.css" rel="stylesheet" type="text/css" />
<!--皮肤（缇娜）-->
<link href="${pageContext.request.contextPath}/static/default/javaex/pc/css/skin/tina.css" rel="stylesheet" type="text/css" />
<!--jquery，请勿轻易修改版本-->
<script language="JavaScript" src="${pageContext.request.contextPath}/static/default/javaex/pc/lib/jquery-1.7.2.min.js" charset="UTF-8"></script>
<!--全局动态修改-->
<script language="JavaScript" src="${pageContext.request.contextPath}/static/default/javaex/pc/js/common.js" charset="UTF-8"></script>
<!--核心组件-->
<script language="JavaScript" src="${pageContext.request.contextPath}/static/default/javaex/pc/js/javaex.min.js" charset="UTF-8"></script>
<!--表单验证-->
<script language="JavaScript" src="${pageContext.request.contextPath}/static/default/javaex/pc/js/javaex-formVerify.js" charset="UTF-8"></script>
<!--cookie-->
<script language="JavaScript" src="${pageContext.request.contextPath}/static/default/js/cookie.js" charset="UTF-8"></script>
