...
<!--全局动态修改-->
<script src="${pageContext.request.contextPath}/static/default/javaex/pc/js/common.js" language="JavaScript" charset="UTF-8"></script>
<!--核心组件-->
...
<!--表单验证-->
<script src="${pageContext.request.contextPath}/static/default/javaex/pc/js/javaex-formVerify.js" language="JavaScript" charset="UTF-8"></script>
<!--顶部导航-->
<div id="nav" class="admin-iframe-header">
	<h1 class="logo"><a href="javascript:;">马丁后台管理</a></h1>
