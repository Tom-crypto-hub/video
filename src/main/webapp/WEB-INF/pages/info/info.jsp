...
<head>
    ...
    <link rel="stylesheet" href="${baseUrl}/css/info/normalize.css">
    <link rel='stylesheet' href='${baseUrl}/css/info/bootstrap.css'>
    <link rel="stylesheet" href="${baseUrl}/css/info/info.css">
</head>
<body>
...
<%--                <h1>tip</h1>--%>
                ...
                <a class="btn green" href="${baseUrl}/index.jsp">HOME</a>
            </div>
        </div>
    </div>
</main>
