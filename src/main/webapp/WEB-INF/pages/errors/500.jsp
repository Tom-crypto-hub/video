...
<head>
    ...
    <title>500 CodePen - Woops. toast</title>
    <link rel="stylesheet" href="${baseurl}/css/500.css">
...
<div class="main-error-page">
    ...
    <h2 class="error-subtitle">
        <!--    Have you tried turning it off and on again?<a href="../../../index.jsp">return home</a>-->
        您试过把它关掉重新打开吗?    <a href="${baseurl}/index.jsp">返回 首页</a>
    </h2>
